---
title: 'Sanity Check Typhoon Melor: Adjusted Causal Model, Unadjusted Causal Model,
  and associational model'
output:
...
nrow(typhoon_melor_2015)
```

# Adjsuted Causal Model
...
adj_base_rain_model <- readRDS(here("adjusted SCM/new base models", 
...
adj_base_models_list <- list("base_wind_model" = adj_base_wind_model, 
                             "base_rain_model" = adj_base_rain_model,
...
adj_trunc_rain_model <- readRDS(here("adjusted SCM/new trunc models", 
...
adj_trunc_models_list <- list("trunc_wind_model" = adj_trunc_wind_model,
                               "trunc_rain_model" = adj_trunc_rain_model,
...
adj_M15_preds  <- adj_hurdle_function(df = typhoon_melor_2015,
...
unadj_base_wind_model <- readRDS(file.path(unadj_base_file_path, 
                                     "dec_base_wind_model_tuned.rds"))
unadj_base_rain_model <- readRDS(here("unadjusted SCM/new base models", 
                                "dec_base_rain_model_tuned.rds"))
...
unadj_base_models_list <- list("base_wind_model" = unadj_base_wind_model, 
                         ...
                         "base_rain_model" = unadj_base_rain_model,
...
unadj_trunc_wind_model <- readRDS(file.path(unadj_trunc_file_path,
                                      "trunc_wind_model_tuned.rds"))
unadj_trunc_rain_model <- readRDS(here("unadjusted SCM/new trunc models", 
                                "dec_trunc_rain_model_tuned.rds"))
...
unadj_trunc_models_list <- list("trunc_wind_model" = unadj_trunc_wind_model,
                                "trunc_rain_model" = unadj_trunc_rain_model,
...
unadj_M15_preds  <- unadj_hurdle_function(df = typhoon_melor_2015,
...
ass_M15_preds <- ass_hurdle_function(df = typhoon_melor_2015, ass_clas_model = clas_model,
...
melor_2015_preds  <-  typhoon_melor_2015 %>%
  mutate(adj_M15_preds = adj_M15_preds,
         unadj_M15_preds = unadj_M15_preds,
         ass_M15_preds = ass_M15_preds) 

# write to file
write.csv(melor_2015_preds, here("hurdle comparisons", "melor_2015_preds.csv"))
```
