...
melor_preds <- adjHurdleFun(df = typhoon_melor_2015, scm_models_base = base_models_list,
  scm_models_high = trunc_models_list, threshold = threshold
)

typhoon_melor_2015$forecast <- melor_preds
```

```{r}
# 
write.csv(melor_preds, file = here("adjusted SCM/outputs", "melor_2015_preds.csv"))
```
