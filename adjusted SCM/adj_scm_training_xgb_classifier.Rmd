...
df_base_train2[["rain_total_pred"]] <- predict(base_wind_model, newdata = df_base_train2)
...
mlflow_set_experiment(experiment_name = "Attempt 2: SCM - XGBOOST classification - CV (Training metircs)")
...
# OLD CODE: HOW TO SAVE MULTIPLE MODELS
# ------------ Models in a list -----------------------
