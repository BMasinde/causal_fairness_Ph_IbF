...
df_base_test[["rain_total_pred"]] <- predict(base_wind_model, newdata = df_base_test)
...
y_preds_probs <- predict(base_class_full_model, newdata = df_base_test, type = "prob")[,2]  # Probability of class 1
```
...
mlflow_set_experiment(experiment_name = "Attempt2: SCM - XGBOOST classification -CV (Test metircs)")
...
# OLD CODE: Reading multiple models
...
# Predicting parent nodes efficiently
