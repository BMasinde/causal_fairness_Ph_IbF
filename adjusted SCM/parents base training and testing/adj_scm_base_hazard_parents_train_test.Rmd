...
```{r}
png(here("adjusted SCM/outputs", "dec_wind_base_model.png"), 
       width = 6, 
       units = "in",
       height = 4,
    res = 300)
dec_base_wind_plot <- rpart.plot(dec_base_wind_model_tuned$finalModel)
dev.off()
```
...
```{r}
png(here("adjusted SCM/outputs", "dec_rain_base_model.png"), 
       width = 6, 
       units = "in",
       height = 4,
    res = 300)
