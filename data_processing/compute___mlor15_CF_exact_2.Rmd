---
title: "Create exact counterfactuals: Two hypothetical municipalities"
output:
...
low_vul_building_vals <- c(80, 2,2,2,10,2,2,2, 2)
...
```{r}
high_vul_building_vals <- c(10, 2,2,2,80,2,2,2, 2)
...
```{r}
write.csv(low_melor_2015, here("data", "low_melor15_CF_data_2.csv"))

write.csv(high_melor_2015, here("data", "high_melor15_CF_data_2.csv"))
```
