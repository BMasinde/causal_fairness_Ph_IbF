---
title: "Unadjusted SCM Base Regression Training"
...
for (col in rain_fractions) {
  ...
  df_base_train2 [[new_col_name]] <- df_base_train2 [[col]] * df_base_train2 [["rain_total"]]
}
```
...
mlflow_set_experiment(experiment_name = "Attempt 2: U-SCM - XGBOOST base regression - CV (Training metircs)")
